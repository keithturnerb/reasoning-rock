/**
 * This script is used by the files in internals in this project.
 * Ref from boilerplate, it will run all generators in order to be able to lint them
 * and detect critical errors. Every generated component's name starts with 'RbGenerated'
